<?php 
  ...
  if(isset($_POST["login"])){
    ...
    // cek user
    $result = mysqli_query($koneksi, "SELECT * FROM adming WHERE username = '$username'");
        ...
        <div class="col-md-6 col-md-offset-3">
          <div class="thumbnail">
            <form class="form-signin" action="" method="post">
              <h3 class="form-signin-heading">Please sign in, Adming</h3><br>
              ...
              <p class="text-right warna getar">
                ...
                <p>Belum Punya Akun? <a href="daftaradming.php">Sign Up</a></p>
