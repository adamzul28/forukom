    ...
    if(register($_POST) > 0 ){
      ?>
        <script type="text/javascript">
          alert('Username berhasil terdaftar. silahkan login');
...
<html lang="en">
  <head>
    ...
    <title>Pendaftaran Admin GarapCode</title>
        ...
        <div class="col-md-6 col-md-offset-3">
          <div style="height: 700px;" class="thumbnail">
            <form class="form-signin" action="" method="post" enctype="multipart/form-data">
              <h3 class="form-signin-heading">Pendaftaran Admin GarapCode</h3><br>
              
              <input type="text" name="nama" id="inputEmail" class="input2" placeholder="Nama Lengkap"  autofocus>

              <p class="text-right getar warna">
                <?= @$_GET["nama"]; ?>
              </p>

              <input type="text" name="email" id="inputEmail" class="input2" placeholder="Alamat Email"  autofocus><br>
              ...
              <input minlength="6" type="password" name="password" id="inputPassword" class="input2" placeholder="Password (Minimal 6 Karakter)" ><br><br>
              ...
              <label for="inputEmail">Masukan Foto (Max 2 Mb)</label>
              <input type="file" name="foto" id="inputEmail" placeholder="Foto"  autofocus><br>
